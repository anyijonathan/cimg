    ...
    <header className="z-40 py-4 bg-other-background shadow-bottom font-circular-std">
      <div className="container flex items-center justify-between h-full px-6 mx-auto text-gray-600 ">
        ...
        <button
          ...
          aria-label="Menu"
        >
          <MenuIcon  className="fill-primary-color w-6 h-6" aria-hidden="true" />
        </button>
        ...
        <ul className="flex items-center flex-shrink-0 space-x-6">
          <li className="flex">
            <div className='justify-center flex items-center'>
              <UserIcon />
              <p className='font-medium text-sm text-black-primary pl-4'>{userName}</p>
            </div>
          </li>
          ...
          <li className="relative md:pl-[4.5625rem]">
            <div className='justify-center flex items-center'>
              <SignoutIcon />
              <button onClick={handleSignout} className='font-medium text-sm text-red-primary pl-4'>Sign Out</button>
            </div>   
          </li>
        </ul>
      </div>
