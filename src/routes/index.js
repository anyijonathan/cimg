...
const AdminEditFeeSetup = lazy(() =>
	import("../pages/AdminPages/EditFeeSetup")
);
const AdminTransactionInfo = lazy(() =>
	import("../pages/AdminPages/TransactionInfo")
);

const SuperAdminDashboard = lazy(() =>
	import("../pages/SuperAdminPages/Dashboard")
);
const SuperAdminVendors = lazy(() =>
	import("../pages/SuperAdminPages/VendorComponents/Vendors")
);
const SuperAdminVendorInfo = lazy(() =>
	import("../pages/SuperAdminPages/VendorInfo")
);
const SuperAdminTelcos = lazy(() =>
	import("../pages/SuperAdminPages/TelcoComponents/Telcos")
);
const SuperAdminTelcoInfo = lazy(() =>
	import("../pages/SuperAdminPages/TelcoInfo")
);
const SuperAdminVendorTelco = lazy(() =>
	import("../pages/SuperAdminPages/VendorTelcoComponents/VendorTelco")
);
const SuperAdminFeeSetup = lazy(() =>
	import("../pages/SuperAdminPages/FeeSetUpComponents/FeeSetup")
);
const SuperAdminReports = lazy(() =>
	import("../pages/SuperAdminPages/Reports")
);
const SuperAdminSettings = lazy(() =>
	import("../pages/SuperAdminPages/Settings")
);
const SuperAdminNewFeeSetup = lazy(() =>
	import("../pages/SuperAdminPages/FeeSetUpComponents/NewFeeSetup")
);
const SuperAdminEditFeeSetup = lazy(() =>
	import("../pages/SuperAdminPages/FeeSetUpComponents/EditFeeSetup")
);
const SuperAdminTransactionInfo = lazy(() =>
	import("../pages/SuperAdminPages/TransactionInfo")
);
